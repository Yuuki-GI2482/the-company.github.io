    ...
    <div class="col-4">
      ...
      <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="first_name" id="first_name" value="<?= $user['first_name']?>" class="form-control" required autofocus>
        </div>

        <div class="mb-3">
          <label for="last_name" class="form-label">last Name</label>
          <input type="text" name="last_name" id="last_name" value="<?= $user['last_name']?>" class="form-control" required autofocus>
        </div>

        <div class="mb-3">
          <label for="username" class="form-label">Last Name</label>
          <input type="text" name="username" id="username" value="<?= $user['username']?>" class="form-control" required autofocus>
        </div>
